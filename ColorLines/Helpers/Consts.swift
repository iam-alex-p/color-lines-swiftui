...
struct MoveComments {
    ...
    static let missedMoves = ["Getting there 🌞", "You are getting closer 🏎️", "More Balls 🍡 More Opportunities 🥳", "One more step closer 🪜", "See the Goal 🎯", "It's getting tighter 😖", "Fresh Balls just for you 🍡", "Keep going 🥾", "Almost there 😅", "One more Move 😜", "You can do it 💪🏾", "Keep going 👍🏽"]
    ...
    static let gameOver = ["Great Job 🌞 One more time? 😉", "Wow 😲 You've nailed it 👍🏽", "Wow! What a Game 👌🏾", "You've done a Great Job 🤩", "Look at your score 😎", "Impressive Game 🙀"]
}
